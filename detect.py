...
def run(window,
        ...
        source='TestImages/video2.mp4',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='TestImages/bus.img', help='file/dir/URL/glob, 0 for webcam')
